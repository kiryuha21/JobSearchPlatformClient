    ...
    Card(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(text = resume.applyPosition, fontSize = 24.sp, modifier = Modifier.offset(x = 10.dp))
            }
            Spacer(modifier = Modifier.height(10.dp))

            Row(verticalAlignment = Alignment.CenterVertically) {
                Icon(imageVector = Icons.Filled.Person, contentDescription = "full name")
                Text(text = resume.fullName(), fontSize = 18.sp, modifier = Modifier.offset(x = 10.dp))
            }
            Row(verticalAlignment = Alignment.CenterVertically) {
                Icon(imageVector = Icons.Filled.Email, contentDescription = "email")
                Text(text = "email: ${resume.contactEmail}", fontSize = 16.sp, modifier = Modifier.offset(x = 10.dp))
            }
            Row(verticalAlignment = Alignment.CenterVertically) {
                Icon(imageVector = Icons.Filled.Phone, contentDescription = "contact phone")
                Text(text = "Контактный телефон: ${resume.phoneNumber}", fontSize = 16.sp, modifier = Modifier.offset(x = 10.dp))
            }
            Spacer(modifier = Modifier.height(10.dp))
            ...
            if (isExpanded) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(text = "Стаж работы:", fontSize = 16.sp, modifier = Modifier.offset(x = 10.dp))
                }
